...
class S {
  ...
  /// `To perform this transaction, you must has been do the Transfer from your PayPal Account to us`
  ...
  String get paypalDisclosureTransfer {
    return Intl.message(
      'To perform this transaction, you must: 1- Send the transfer from your own PayPal (Button PayPal Transfer) 2- Request the Transfer when done (Button PayPal Load)',
      name: 'paypalDisclosureTransfer',
      desc: '',
      args: [],
    );
  }
  ...
  String get toMobileDisclosure {
    return Intl.message(
      'The maximum amount allowed for this transaction is \$100.00.',
